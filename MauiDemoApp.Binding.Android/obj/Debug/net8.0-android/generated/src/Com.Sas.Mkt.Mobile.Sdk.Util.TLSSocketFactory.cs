...
namespace Com.Sas.Mkt.Mobile.Sdk.Util {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.sas.mkt.mobile.sdk.util']/class[@name='TLSSocketFactory']"
	[global::Android.Runtime.Register ("com/sas/mkt/mobile/sdk/util/TLSSocketFactory", DoNotGenerateAcw=true)]
	public partial class TLSSocketFactory : global::Javax.Net.Ssl.SSLSocketFactory {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/sas/mkt/mobile/sdk/util/TLSSocketFactory", typeof (TLSSocketFactory));
		...
		protected TLSSocketFactory (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.sas.mkt.mobile.sdk.util']/class[@name='TLSSocketFactory']/constructor[@name='TLSSocketFactory' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe TLSSocketFactory () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		static Delegate GetCreateSocket_Ljava_lang_String_IHandler ()
		{
			if (cb_createSocket_Ljava_lang_String_I == null)
				cb_createSocket_Ljava_lang_String_I = JNINativeWrapper.CreateDelegate (new _JniMarshal_PPLI_L (n_CreateSocket_Ljava_lang_String_I));
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Sas.Mkt.Mobile.Sdk.Util.TLSSocketFactory> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.sas.mkt.mobile.sdk.util']/class[@name='TLSSocketFactory']/method[@name='createSocket' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='int']]"
...
#pragma warning disable 0169
		static Delegate GetCreateSocket_Ljava_lang_String_ILjava_net_InetAddress_IHandler ()
		{
			if (cb_createSocket_Ljava_lang_String_ILjava_net_InetAddress_I == null)
				cb_createSocket_Ljava_lang_String_ILjava_net_InetAddress_I = JNINativeWrapper.CreateDelegate (new _JniMarshal_PPLILI_L (n_CreateSocket_Ljava_lang_String_ILjava_net_InetAddress_I));
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.sas.mkt.mobile.sdk.util']/class[@name='TLSSocketFactory']/method[@name='createSocket' and count(parameter)=4 and parameter[1][@type='java.lang.String'] and parameter[2][@type='int'] and parameter[3][@type='java.net.InetAddress'] and parameter[4][@type='int']]"
...
#pragma warning disable 0169
		static Delegate GetCreateSocket_Ljava_net_InetAddress_IHandler ()
		{
			if (cb_createSocket_Ljava_net_InetAddress_I == null)
				cb_createSocket_Ljava_net_InetAddress_I = JNINativeWrapper.CreateDelegate (new _JniMarshal_PPLI_L (n_CreateSocket_Ljava_net_InetAddress_I));
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.sas.mkt.mobile.sdk.util']/class[@name='TLSSocketFactory']/method[@name='createSocket' and count(parameter)=2 and parameter[1][@type='java.net.InetAddress'] and parameter[2][@type='int']]"
...
#pragma warning disable 0169
		static Delegate GetCreateSocket_Ljava_net_InetAddress_ILjava_net_InetAddress_IHandler ()
		{
			if (cb_createSocket_Ljava_net_InetAddress_ILjava_net_InetAddress_I == null)
				cb_createSocket_Ljava_net_InetAddress_ILjava_net_InetAddress_I = JNINativeWrapper.CreateDelegate (new _JniMarshal_PPLILI_L (n_CreateSocket_Ljava_net_InetAddress_ILjava_net_InetAddress_I));
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.sas.mkt.mobile.sdk.util']/class[@name='TLSSocketFactory']/method[@name='createSocket' and count(parameter)=4 and parameter[1][@type='java.net.InetAddress'] and parameter[2][@type='int'] and parameter[3][@type='java.net.InetAddress'] and parameter[4][@type='int']]"
...
#pragma warning disable 0169
		static Delegate GetCreateSocket_Ljava_net_Socket_Ljava_lang_String_IZHandler ()
		{
			if (cb_createSocket_Ljava_net_Socket_Ljava_lang_String_IZ == null)
				cb_createSocket_Ljava_net_Socket_Ljava_lang_String_IZ = JNINativeWrapper.CreateDelegate (new _JniMarshal_PPLLIZ_L (n_CreateSocket_Ljava_net_Socket_Ljava_lang_String_IZ));
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.sas.mkt.mobile.sdk.util']/class[@name='TLSSocketFactory']/method[@name='createSocket' and count(parameter)=4 and parameter[1][@type='java.net.Socket'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='int'] and parameter[4][@type='boolean']]"
...
#pragma warning disable 0169
		static Delegate GetGetDefaultCipherSuitesHandler ()
		{
			if (cb_getDefaultCipherSuites == null)
				cb_getDefaultCipherSuites = JNINativeWrapper.CreateDelegate (new _JniMarshal_PP_L (n_GetDefaultCipherSuites));
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.sas.mkt.mobile.sdk.util']/class[@name='TLSSocketFactory']/method[@name='getDefaultCipherSuites' and count(parameter)=0]"
...
#pragma warning disable 0169
		static Delegate GetGetSupportedCipherSuitesHandler ()
		{
			if (cb_getSupportedCipherSuites == null)
				cb_getSupportedCipherSuites = JNINativeWrapper.CreateDelegate (new _JniMarshal_PP_L (n_GetSupportedCipherSuites));
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.sas.mkt.mobile.sdk.util']/class[@name='TLSSocketFactory']/method[@name='getSupportedCipherSuites' and count(parameter)=0]"
