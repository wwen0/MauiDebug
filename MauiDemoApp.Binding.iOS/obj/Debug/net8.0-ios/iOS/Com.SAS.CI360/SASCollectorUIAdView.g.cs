...
namespace Com.SAS.CI360 {
	...
	public unsafe partial class SASCollectorUIAdView : SASIA_Ad {
		...
		/// <summary>Creates a new <see cref="SASCollectorUIAdView" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		/// <summary>Appearance class for objects of type <see cref="global::Com.SAS.CI360.SASCollectorUIAdView" />.</summary>
		/// <remarks>
		///     <para>This appearance class is a strongly typed subclass of UIAppearance that is intended to be used with objects of class <see cref="global::Com.SAS.CI360.SASCollectorUIAdView" />.</para>
		///     <para>You can obtain an instance to this class by either accessing the static <see cref="global::Com.SAS.CI360.SASCollectorUIAdView.Appearance" /> property or by calling <see cref="global::Com.SAS.CI360.SASCollectorUIAdView.AppearanceWhenContainedIn(System.Type[])" /> to get a UIAppearance that is context sensitive.</para>
		/// </remarks>
		...
		/// <remarks>
		///   <para>Setting any appearance properties on this instance will affect the appearance of all instances of <see cref="global::Com.SAS.CI360.SASCollectorUIAdView" />.</para>
		///   <para>If developers want to control the appearance of subclasses of <see cref="global::Com.SAS.CI360.SASCollectorUIAdView" />, they should use the <see cref="global::Com.SAS.CI360.SASCollectorUIAdView.GetAppearance&lt;T&gt;(UIKit.UITraitCollection,System.Type[])" /> method.</para>
		/// </remarks>
		...
		/// <summary>Obtains the appearance proxy <see cref="global::Com.SAS.CI360.SASCollectorUIAdView.SASCollectorUIAdViewAppearance" /> for the subclass of <see cref="global::Com.SAS.CI360.SASCollectorUIAdView" />.</summary>
		/// <typeparam name="T">The type for which the <see cref="global::UIKit.UIAppearance" /> proxy must be returned.  This is a subclass of <see cref="global::Com.SAS.CI360.SASCollectorUIAdView" />.</typeparam>
		/// <returns>
		///   <para>An appearance proxy object for the specified type.</para>
		/// </returns>
		/// <remarks>
		///   <para>Setting any appearance properties on the returned object will affect the appearance of all classes and subclasses of the type parameter.</para>
		///   <para>Unlike the <see cref="global::Com.SAS.CI360.SASCollectorUIAdView.Appearance" /> property, or the <see cref="global::Com.SAS.CI360.SASCollectorUIAdView.AppearanceWhenContainedIn(System.Type[])" /> method which only work on instances of this particular class, the proxies returned by this method can be used to change the style of subclasses.</para>
		///   <para>The following example shows how this method works:</para>
		///   <example>
		///   <code lang="csharp lang-csharp"><![CDATA[
		///var myTheme = SASCollectorUIAdView.GetAppearance<MySASCollectorUIAdViewSubclass> ();
		...
		/// <summary>Obtains the appearance proxy <see cref="global::Com.SAS.CI360.SASCollectorUIAdView.SASCollectorUIAdViewAppearance" /> for <see cref="global::Com.SAS.CI360.SASCollectorUIAdView" />.</summary>
		...
		///var myTheme = SASCollectorUIAdView.GetAppearance (myTraits);
		///myTheme.TintColor = UIColor.Red;
		///]]></code>
		///   </example>
		///   <para>If developers want to control the appearance of subclasses of <see cref="global::Com.SAS.CI360.SASCollectorUIAdView" />, they should use the <see cref="global::Com.SAS.CI360.SASCollectorUIAdView.GetAppearance&lt;T&gt;(UIKit.UITraitCollection)" /> method.</para>
		///   <para>For more information, see the documentation for the <see cref="global::UIKit.UIAppearance" /> class.</para>
		/// </remarks>
		...
		///   <code lang="csharp lang-csharp"><![CDATA[
		///var myTraits = new UITraitCollection ();
		///var myTheme = SASCollectorUIAdView.GetAppearance (myTraits, typeof (UINavigationBar), typeof (UIPopoverController));
		///myTheme.TintColor = UIColor.Red;
		///]]></code>
		///   </example>
		///   <para>If developers want to control the appearance of subclasses of <see cref="global::Com.SAS.CI360.SASCollectorUIAdView" />, they should use the <see cref="global::Com.SAS.CI360.SASCollectorUIAdView.GetAppearance&lt;T&gt;(UIKit.UITraitCollection,System.Type[])" /> method.</para>
		...
		///   <code lang="csharp lang-csharp"><![CDATA[
		///var myTraits = new UITraitCollection ();
		///var myTheme = SASCollectorUIAdView.GetAppearance<MySASCollectorUIAdViewSubclass> (myTraits);
		///myTheme.TintColor = UIColor.Red;
		///]]></code>
		///   </example>
		///   <para>For more information, see the documentation for the <see cref="global::UIKit.UIAppearance" /> class.</para>
		...
		///   <code lang="csharp lang-csharp"><![CDATA[
		///var myTraits = new UITraitCollection ();
		///var myTheme = SASCollectorUIAdView.GetAppearance<MySASCollectorUIAdViewSubclass> (myTraits, typeof (UINavigationBar), typeof (UIPopoverController));
		///myTheme.TintColor = UIColor.Red;
		///]]></code>
		///   </example>
		///   <para>For more information, see the documentation for the <see cref="global::UIKit.UIAppearance" /> class.</para>
